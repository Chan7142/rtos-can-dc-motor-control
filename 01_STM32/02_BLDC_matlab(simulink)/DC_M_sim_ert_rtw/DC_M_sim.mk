###########################################################################
## Makefile generated for Simulink model 'DC_M_sim'. 
## 
## Makefile     : DC_M_sim.mk
## Generated on : Tue May 05 17:46:28 2026
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DC_M_sim.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = DC_M_sim_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = DC_M_sim_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DC_M_sim.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/DC_M_sim_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=DC_M_sim -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/DC_M_sim_ert_rtw/DC_M_sim.c

MAIN_SRC = $(START_DIR)/DC_M_sim_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/DC_M_sim_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
