###########################################################################
## Makefile generated for Simulink model 'BLDC_M_sim'. 
## 
## Makefile     : BLDC_M_sim.mk
## Generated on : Sun Jun 28 17:23:11 2026
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BLDC_M_sim.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/leesc/Desktop/rtos-can-bldc-motor-control/01_STM32/02_BLDC_matlab(simulink)
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = BLDC_M_sim_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = BLDC_M_sim_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BLDC_M_sim.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/BLDC_M_sim_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=BLDC_M_sim -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/BLDC_M_sim_ert_rtw/BLDC_M_sim.c

MAIN_SRC = $(START_DIR)/BLDC_M_sim_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/BLDC_M_sim_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
